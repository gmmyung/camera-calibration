  ...
  return (
    <div class="app-shell">
      ...
      <footer>
        ...
        <div class="footer-meta"><a href="https://github.com/gmmyung/camera-calibration" target="_blank" rel="noopener noreferrer">GitHub</a><span>{opencvVersion ? `OpenCV ${opencvVersion}` : "OpenCV unavailable"}</span></div>
      </footer>
